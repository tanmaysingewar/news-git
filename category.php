      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                $reasult1= mysqli_query($conn,$sql1) or die("Query error");
                $head = mysqli_fetch_assoc($reasult1);
                ?>
                  <h2 class="page-heading"><?php echo $head['category_name'];?></h2>
                  <?php
                        ...
                        <?php
                                ...
                                if (mysqli_num_rows($reasult1)>0) {
                                    ...
                                    if ($page >1) {
                                        echo '<li><a href="category.php?page='.($page - 1 ).'&cid='. $cat_id.'">Pre</a></li>';
                                    }
